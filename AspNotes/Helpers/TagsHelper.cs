...
/// </summary>
public static partial class TagsHelper
{
    /// <summary>
    ...
    /// <returns>A list of tags extracted from the input string.
    /// If the input string is null or empty, returns an empty list.</returns>
    public static List<string> Extract(string tags)
    {
        ...
        {
            var cleanedTag = TagsReplaceRegex().Replace(tag, string.Empty);
    ...
    /// <summary>
    /// Provides a <see cref="ValueConverter{TModel,TProvider}"/> for converting between lists
    /// of tags and their string representation.
    /// </summary>
    /// <returns>A <see cref="ValueConverter{TModel,TProvider}"/> that can be used to convert between a list
    /// of strings and a single string representation.</returns>
