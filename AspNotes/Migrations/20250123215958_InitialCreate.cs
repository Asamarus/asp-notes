        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleSearchIndex = table.Column<string>(type: "TEXT", nullable: true),
                    Section = table.Column<string>(type: "TEXT", nullable: false),
                    Content = table.Column<string>(type: "TEXT", nullable: true),
                    ContentSearchIndex = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotesTags", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notes_Section",
                table: "Notes",
                column: "Section");

            migrationBuilder.CreateIndex(
                name: "IX_NotesTags_NoteId",
                table: "NotesTags",
                column: "NoteId");

            migrationBuilder.CreateIndex(
                name: "IX_NotesTags_NoteId_TagId",
                table: "NotesTags",
