...
import modalsReducer, { ActionType } from './reducer'
...
import type { ModalData, ModalSettings, OpenModalParams, ActiveModal } from './types'
...
function ModalsManager({ modals, commonModalProps }: ModalsManagerProps) {
  ...
  }, [location.key, modals, onCloseModal, onOpenModal, urlParams])
